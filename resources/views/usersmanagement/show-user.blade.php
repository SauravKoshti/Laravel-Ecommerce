              ...
              <div class="col-sm-4 col-md-6">
                ...
                @if ($user->profile)
                  <div class="text-center text-left-tablet mb-4">
                    ...
                    <a href="/project/users/{{$user->id}}/edit" class="btn btn-sm btn-warning" data-toggle="tooltip" data-placement="top" title="{{ trans('usersmanagement.editUser') }}">
                      <i class="fa fa-edit fa-fw" aria-hidden="true"></i> <span class="hidden-xs hidden-sm hidden-md"> {{ trans('usersmanagement.editUser') }} </span>
                    </a>

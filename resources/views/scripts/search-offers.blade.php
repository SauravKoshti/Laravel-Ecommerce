<script>
    $(function() {
        ...
        var usersTable = $('#offers_table');
        var resultsContainer = $('#search_results');
        var usersCount = $('#offer_count');
        var clearSearchTrigger = $('.clear-search');
        var searchform = $('#search_offers');
        var searchformInput = $('#offer_search_box');
                    ...
                    if (jsonData.length != 0) {
                        $.each(jsonData, function(index, val) {
                            ...
                            resultsContainer.append('<tr>' +
                                ...
                                '<td class="hidden-xs">' + val.start_date + '</td>' +
                                '<td class="hidden-xs">' + val.end_date + '</td>' +
                                '<td class="hidden-xs">' + val.offer_quantity + '</td>' +
                                '<td class="hidden-xs"> ' + val.offer_price  +'</td>' +

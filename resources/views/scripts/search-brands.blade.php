<script>
    $(function() {
        ...
        var usersTable = $('#brands_table');
        var resultsContainer = $('#search_results');
        var usersCount = $('#user_count');
        var clearSearchTrigger = $('.clear-search');
        var searchform = $('#search_brand');
        var searchformInput = $('#brand_search_box');
        ...
        searchform.submit(function(e) {
         ...
         $.ajax({
            ...
            success: function (result) {
                ...
                let editCellHtml = '<a class="btn btn-sm btn-info btn-block" href="brands/' + val.brand_id + '/edit" data-toggle="tooltip" title="{{ trans("usersmanagement.tooltips.edit") }}">{!! trans("usersmanagement.buttons.edit") !!}</a>';
                let deleteCellHtml = '<form method="POST" action="/brands/'+ val.brand_id +'" accept-charset="UTF-8" data-toggle="tooltip" title="Delete">' +
                ...
                resultsContainer.append('<tr>' +
                    ...
                    '<td class="hidden-xs">' + val.brand_status + '</td>' +

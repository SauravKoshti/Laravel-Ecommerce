<script>
    $(function() {
        ...
        var usersTable = $('#colors_table');
        var resultsContainer = $('#search_results');
        var usersCount = $('#color_count');
        var clearSearchTrigger = $('.clear-search');
        var searchform = $('#search_colors');
        var searchformInput = $('#color_search_box');
                    ...
                    if (jsonData.length != 0) {
                        $.each(jsonData, function(index, val) {
                            ...
                            resultsContainer.append('<tr>' +
                                ...
                                '<td class="hidden-xs">' + val.icon_tag + '</td>' +

        ...
        <div class="row">
            <div class="col-lg-10 offset-lg-1">
                <div class="card">
                    ...
                    <div class="card-body">
                        {!! Form::open(array('route' => 'restricrated-states.store', 'method' => 'POST', 'role' => 'form', 'enctype' => 'multipart/form-data' ,'class' => 'needs-validation')) !!}
                            ...
                            <div class="form-group has-feedback row {{ $errors->has('state_name') ? ' has-error ' : '' }}">
                                ...
                                <div class="col-md-9">
                                    <div class="input-group">
                                        {!! Form::text('state_name', NULL, array('id' => 'state_name', 'class' => 'form-control', 'placeholder' => 'State Name')) !!}
                            ...
                            {!! Form::button('Create New State', array('class' => 'btn btn-success margin-bottom-1 mb-1 float-right','type' => 'submit' )) !!}
                        {!! Form::close() !!}
                    </div>

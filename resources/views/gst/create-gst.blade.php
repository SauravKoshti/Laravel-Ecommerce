...
{!! trans('gstmanagement.create-new-gst') !!}
@endsection
    ...
    <div class="row">
        <div class="col-lg-10 offset-lg-1">
            <div class="card mt-5">
                <div class="card-header">
                    <div style="display: flex; justify-content: space-between; align-items: center;">
                        ...
                        <div class="pull-right">
                            <a href="{{ url('gst') }}" class="btn btn-light btn-sm float-right" data-toggle="tooltip" data-placement="left" title="{{ trans('Back to Gst') }}">
                ...
                <div class="card-body">
                    {!! Form::open(array('route' => 'gst.store', 'method' => 'POST', 'role' => 'form', 'class' => 'needs-validation')) !!}
                        ...
                        <div class="form-group has-feedback row {{ $errors->has('gst_name') ? ' has-error ' : '' }}">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    {!! Form::text('gst_name', NULL, array('id' => 'gst_name', 'class' => 'form-control', 'placeholder' => 'gst name')) !!}
                        ...
                        <div class="form-group has-feedback row {{ $errors->has('gst_percentage') ? ' has-error ' : '' }}">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    {!! Form::text('gst_percentage', NULL, array('id' => 'gst_percentage', 'class' => 'form-control', 'placeholder' => 'GST Percentage')) !!}
                                    <div class="input-group-append">
                        ...
                        {!! Form::button('Create GST', array('class' => 'btn btn-success margin-bottom-1 mb-1 float-right','type' => 'submit' )) !!}
                    {!! Form::close() !!}
                </div>

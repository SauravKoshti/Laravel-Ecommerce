        ...
        <div class="row">
            <div class="col-lg-10 offset-lg-1 py-5">
                <div class="card">
                    <div class="card-header">
                        ...
                        Create New Category
                            <div class="pull-right">
                                <button class="btn btn-primary"><a href="{{ URL::to('/category') }}" class="btn btn-light btn-sm float-right" data-toggle="tooltip" data-placement="left" title="{{ trans('usersmanagement.tooltips.back-users') }}">
                    ...
                    <div class="card-body">
                        {!! Form::open(array('route' => 'category.store', 'method' => 'POST', 'role' => 'form', 'enctype' => 'multipart/form-data', 'class' => 'needs-validation')) !!}
                            ...
                            <div class="form-group has-feedback row {{ $errors->has('category_name') ? ' has-error ' : '' }}">
                                ...
                                <div class="col-md-9">
                                    <div class="input-group">
                                        {!! Form::text('category_name', NULL, array('id' => 'category_name', 'class' => 'form-control', 'placeholder' => 'Category Name')) !!}

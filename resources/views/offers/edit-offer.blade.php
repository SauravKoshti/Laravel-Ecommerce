        ...
        <div class="row">
            <div class="col-lg-10 offset-lg-1">
                <div class="card">
                    ...
                    <div class="card-body">
                        {!! Form::open(array('route' => ['offers.update', $offer->offer_id], 'method' => 'PUT', 'role' => 'form', 'class' => 'needs-validation')) !!}
                            ...
                            <div class="form-group has-feedback row {{ $errors->has('offer_name') ? ' has-error ' : '' }}">
                                ...
                                <div class="col-md-9">
                                    <div class="input-group">
                                        {!! Form::text('offer_name', $offer->offer_name, array('id' => 'offer_name', 'class' => 'form-control', 'placeholder' => 'Offer Name')) !!}
                            ...
                            <div class="form-group has-feedback row {{ $errors->has('start_date') ? ' has-error ' : '' }}">
                                ...
                                <div class="col-md-9">
                                    <div class="input-group ">
                                        <input type="date" value="{{ $offer->start_date }}" name="start_date" class="form-control" id=""/>
                                        <div class="input-group-append">
                            ...
                            <div class="form-group has-feedback row {{ $errors->has('end_date') ? ' has-error ' : '' }}">
                                ...
                                <div class="col-md-9">
                                    <div class="input-group ">
                                        <input type="date" value="{{ $offer->end_date }}" name="end_date" class="form-control" id=""/>
                                        <div class="input-group-append">
                            ...
                            <div class="form-group has-feedback row {{ $errors->has('offer_quantity') ? ' has-error ' : '' }}">
                                ...
                                <div class="col-md-9">
                                    <div class="input-group">
                                        {!! Form::text('offer_quantity', $offer->offer_quantity, array('id' => 'offer_quantity', 'class' => 'form-control', 'placeholder' => 'Quantity')) !!}
                                        <div class="input-group-append">
                            ...
                            <div class="form-group has-feedback row {{ $errors->has('offer_price') ? ' has-error ' : '' }}">
                                ...
                                <div class="col-md-9">
                                    <div class="input-group">
                                        {!! Form::text('offer_price', $offer->offer_price, array('id' => 'offer_price', 'class' => 'form-control', 'placeholder' => 'Quantity Price')) !!}
                                        <div class="input-group-append">
                            ...
                            <div class="form-group has-feedback row {{ $errors->has('minimum_quantity') ? ' has-error ' : '' }}">
                                ...
                                <div class="col-md-9">
                                    <div class="input-group">
                                        {!! Form::text('minimum_quantity', $offer->minimum_quantity, array('id' => 'minimum_quantity', 'class' => 'form-control', 'placeholder' => 'Minimum Quantity')) !!}
                                        <div class="input-group-append">
                            ...
                            <div class="form-group has-feedback row {{ $errors->has('maximum_quantity') ? ' has-error ' : '' }}">
                                ...
                                <div class="col-md-9">
                                    <div class="input-group">
                                        {!! Form::text('maximum_quantity', $offer->maximum_quantity, array('id' => 'maximum_quantity', 'class' => 'form-control', 'placeholder' => 'Maximum Quantity')) !!}
                                        <div class="input-group-append">

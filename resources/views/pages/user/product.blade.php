                                        ...
                                        <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                            <div class="products-single fix">
                                                <div class="box-img-hover">
                                                    ...
                                                    <img src="{{asset('images/'.$product->product_images)}}" class="img-fluid" alt="Image">
                                                    <div class="mask-icon">
                                                        <ul>
                                    ...
                                    <div class="list-view-box">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6 col-md-6 col-lg-8 col-xl-8">
                                                <div class="why-text full-width">
                                                    <h4>{{$product->product_name}}</h4>
                                                    <h5> <del>$ 60.00</del> {{$product->product_sale_price}}</h5>
                                                    <p>{{ Str::limit($product->product_description, 100) }}<a class="text-dark " href="{{ URL::to('theway-shop/products/products-details/' . $product->product_id) }}">Read More</a></p>
                                                    <a class="btn hvr-hover" href="#">Add to Cart</a>
                                                </div>
                                            </div>
                                        </div>

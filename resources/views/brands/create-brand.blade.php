    ...
    <div class="row">
        <div class="col-lg-10 offset-lg-1">
            <div class="card mt-5">
                ...
                <div class="card-body">
                    {!! Form::open(array('route' => 'brands.store', 'method' => 'POST', 'role' => 'form', 'class' => 'needs-validation','enctype'=>'multipart/form-data')) !!}
                        ...
                        <div class="form-group has-feedback row {{ $errors->has('brand_name') ? ' has-error ' : '' }}">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    {!! Form::text('brand_name', NULL, array('id' => 'brand_name', 'class' => 'form-control', 'placeholder' => 'Brand Name')) !!}
                        ...
                        <div class="form-group has-feedback row {{ $errors->has('brand_description') ? ' has-error ' : '' }}">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    {!! Form::text('brand_description', NULL, array('id' => 'brand_description', 'class' => 'form-control', 'placeholder' => 'Brand Description')) !!}
                                    <div class="input-group-append">
                        ...
                        {!! Form::button('Create New Brand', array('class' => 'btn btn-success margin-bottom-1 mb-1 float-right','type' => 'submit' )) !!}
                    {!! Form::close() !!}
                </div>

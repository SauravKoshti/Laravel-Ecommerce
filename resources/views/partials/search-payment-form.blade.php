    ...
    <div class="col-sm-8 offset-sm-4 col-md-6 offset-md-6 col-lg-5 offset-lg-7 col-xl-4 offset-xl-8">
        {!! Form::open(['route' => 'search-payments', 'method' => 'POST', 'role' => 'form', 'class' => 'needs-validation', 'id' => 'search_payments']) !!}
            ...
            <div class="input-group mb-3">
                {!! Form::text('payment_search_box', NULL, ['id' => 'payment_search_box', 'class' => 'form-control', 'placeholder' => 'Search Payment', 'aria-label' => trans('usersmanagement.search.search-users-ph'), 'required' => false]) !!}

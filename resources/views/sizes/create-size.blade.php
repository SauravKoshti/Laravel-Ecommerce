        ...
        <div class="row">
            <div class="col-lg-10 offset-lg-1">
                <div class="card">
                    ...
                    <div class="card-body">
                        {!! Form::open(array('route' => 'sizes.store', 'method' => 'POST', 'role' => 'form', 'enctype' => 'multipart/form-data' ,'class' => 'needs-validation')) !!}
                            ...
                            <div class="form-group has-feedback row {{ $errors->has('size_name') ? ' has-error ' : '' }}">
                                ...
                                <div class="col-md-9">
                                    <div class="input-group">
                                        {!! Form::text('size_name', NULL, array('id' => 'size_name', 'class' => 'form-control', 'placeholder' => 'Size Name')) !!}
                            ...
                            {!! Form::button('Create New Size', array('class' => 'btn btn-success margin-bottom-1 mb-1 float-right','type' => 'submit' )) !!}
                        {!! Form::close() !!}
                    </div>

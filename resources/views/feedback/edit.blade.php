                ...
                <div class="card-body">
                    {!! Form::open(array('route' => ['gst.update', $gsts->gst_id], 'method' => 'PUT', 'role' => 'form', 'class' => 'needs-validation','enctype' => 'multipart/form-data')) !!}
                        ...
                        <div class="form-group has-feedback row {{ $errors->has('gst_name') ? ' has-error ' : '' }}">
                            {!! Form::label('gst_name', trans('forms.create_label_gst_name'), array('class' => 'col-md-3 control-label')); !!}
                            <div class="col-md-9">
                                <div class="input-group">
                                    {!! Form::text('gst_name', $gsts->gst_name, array('id' => 'gst_name', 'class' => 'form-control', 'placeholder' => trans('forms.create_label_gst_name'))) !!}
                        ...
                        <div class="form-group has-feedback row {{ $errors->has('gst_percentage') ? ' has-error ' : '' }}">
                            {!! Form::label('gst_percentage', trans('forms.create_label_gst_percentage'), array('class' => 'col-md-3 control-label')); !!}
                            <div class="col-md-9">
                                <div class="input-group">
                                    {!! Form::text('gst_percentage', $gsts->gst_percentage, array('id' => 'gst_percentage', 'class' => 'form-control', 'placeholder' => trans('forms.create_label_gst_percentage'))) !!}
                                    <div class="input-group-append">
                        ...
                        {!! Form::button(trans('forms.edit_gst_button_text'), array('class' => 'btn btn-success margin-bottom-1 mb-1 float-right','type' => 'submit' )) !!}
                    {!! Form::close() !!}
                </div>

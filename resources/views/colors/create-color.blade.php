        ...
        <div class="row">
            <div class="col-lg-10 offset-lg-1">
                <div class="card">
                    ...
                    <div class="card-body">
                        {!! Form::open(array('route' => 'colors.store', 'method' => 'POST', 'role' => 'form', 'enctype' => 'multipart/form-data' ,'class' => 'needs-validation')) !!}
                            ...
                            <div class="form-group has-feedback row {{ $errors->has('color_name') ? ' has-error ' : '' }}">
                                ...
                                <div class="col-md-9">
                                    <div class="input-group">
                                        {!! Form::text('color_name', NULL, array('id' => 'color_name', 'class' => 'form-control', 'placeholder' => 'Color Name')) !!}
                            ...
                            <div class="form-group has-feedback row {{ $errors->has('fa_fa_icon_text') ? ' has-error ' : '' }}">
                                ...
                                <div class="col-md-9">
                                    <div class="input-group">
                                        {!! Form::text('fa_fa_icon_text', NULL, array('id' => 'fa_fa_icon_text', 'class' => 'form-control', 'placeholder' => 'Put Icon Tag', 'onchange' => 'preview_images();')) !!}
                                        <div class="input-group-append">
                            ...
                            {!! Form::button('Add New Color', array('class' => 'btn btn-success margin-bottom-1 mb-1 float-right','type' => 'submit' )) !!}
                        {!! Form::close() !!}
                    </div>
